...
// [t=437] bytemap: 0x9007fbf0, firstAddress: 0x9011c000, size: 10485760, ALLOCATION_ALIGNMENT: 16, bytemap->size: 655360, Bytemap_index: 1310720z
// [t=451] Bytemap_index(bytemap, (word_t *)((ubyte_t *)(firstAddress) + size) - ALLOCATION_ALIGNMENT) < bytemap->size
